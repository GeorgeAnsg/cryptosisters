...
- **Evidencia:** no se ha podido verificar con búsqueda específica en esta sesión (se agotó el presupuesto de WebSearch antes de llegar a este concepto). Por conocimiento general del sector: los estudios académicos de patrones chartistas clásicos más citados (Lo, Mamaysky & Wang, 2000, "Foundations of Technical Analysis", Journal of Finance) encontraron que ciertos patrones (incluidos dobles techos/suelos) tienen algo de contenido informativo estadísticamente detectable usando reconocimiento de patrones no paramétrico sobre acciones de EE.UU. en los años 1962-1996, pero el efecto es pequeño, inconsistente entre períodos, y se diluye con costes de transacción — no es una fuente que hayamos podido releer en esta sesión, se cita de memoria y debe verificarse antes de confiar en ella. **Esto se marca explícitamente como no verificado en esta sesión.**
- **Veredicto:** **plausible pero con evidencia débil/antigua y no cripto-específica; no verificado en esta sesión por límite de búsquedas**.
